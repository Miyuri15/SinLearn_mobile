				...
				child: Container(
					...
					child: Row(
						children: [
							...
							const SizedBox(width: 6),
							Text('Recording', style: theme.textTheme.bodyMedium?.copyWith(color: Colors.red)),
							const Spacer(),
							_Waveform(pulse: pulse, color: Colors.red),
							const Spacer(),
							TextButton.icon(onPressed: onCancel, icon: const Icon(Icons.close), label: const Text('Cancel')),
							const SizedBox(width: 8),
							TextButton.icon(
								onPressed: onStop,
