...
class _QuestionPaperPageState extends State<QuestionPaperPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 420, // match Syllabus sidebar width
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      const SizedBox(height: 12),
                      Text(
                        _file == null ? tr('question_paper.click_to_upload') : tr('question_paper.replace_file'),
                        style: TextStyle(fontSize: 15, color: isDark ? const Color(0xFFAAAAAA) : const Color(0xFF6B7A95)),
                      ),
                    ]),
                  ),
                ),
